...
def run_all_tests():
    ...
    test_cases = [
        ...
        ("NPC delete valid", "storynpcs npc delete storynpcs:guard_captain", "Deleted NPC: storynpcs:guard_captain", "expected deletion"),
        ...
        ("Restore deleted NPC via reload", "storynpcs reload", "reloaded successfully", "expected restored from YAML"),
        ...
        ("Dialogue edit from console", "storynpcs dialogue edit storynpcs:captain_dialogue", "Opening visual dialogue editor", "expected edit message"),
