...
public final class DiagnosticHints {
    ...
    private static final Map<String, String> HINTS = Map.ofEntries(
            ...
            Map.entry("YAML_PARSE_ERROR",
                    "The file is not valid YAML — check indentation, colons, and quotes near the reported line."),
            Map.entry("YAML_MAPPING_ERROR",
                    "A YAML field has the wrong shape (e.g. a list where a value is expected) — compare against a working definition file."),
            Map.entry("IO_ERROR",
